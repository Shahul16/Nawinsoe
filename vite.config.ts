...
import { vitePluginManusRuntime as vitePluginNawinsRuntime } from "vite-plugin-manus-runtime";
...
const plugins = [react(), tailwindcss(), jsxLocPlugin(), vitePluginNawinsRuntime(), vitePluginDebugCollector()];
