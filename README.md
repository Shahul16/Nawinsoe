...
- **Task workflow included:** `tasks` procedures support create/list/updateStatus/complete with browser notifications on completion.
- **SEO baseline included:** centralized route-aware title and meta description updates in the frontend app shell.
