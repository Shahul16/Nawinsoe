...
Resources: [
  ...
  { id: "student-essentials", label: "Student Essentials", href: "/student-essentials" },
  { id: "refer-friend", label: "Refer a Friend", href: "/refer-a-friend" },
],
  Legal: [
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8 mb-12">
          ...
          <div className="lg:col-span-1">
            <div className="mb-4 flex items-center gap-3">
                ...
                <div className="relative h-12 w-12 rounded-full overflow-hidden bg-white/15">
                  <Logo className="absolute inset-0 w-full h-full object-contain" width={48} height={48} />
                </div>
              </div>
              <div>
            ...
            <div className="space-y-3">
              ...
              <div className="flex items-center gap-2">
                ...
                <a href="tel:+919943738177" className="text-sm text-blue-100/90 hover:text-amber-300">
                  +91 99437 38177 (India)
                </a>
              </div>
              <div className="flex items-center gap-2">
                <Phone className="w-4 h-4 text-amber-300" />
                <a href="tel:+447778099414" className="text-sm text-blue-100/90 hover:text-amber-300">
                  +44 77780 99414 (UK)
                </a>
              </div>
