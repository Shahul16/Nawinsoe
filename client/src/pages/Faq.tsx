...
const faqCategories = [
  {
    ...
    items: [
      {
        question: "What services does Nawins Overseas Education provide?",
        answer: "We provide comprehensive study abroad consulting services including university selection, application assistance, visa guidance, test preparation, scholarship assistance, and pre-departure orientation. Our team of experienced counselors helps students navigate the entire process of studying abroad."
      },
      {
        question: "Which countries does Nawins help students study in?",
      ...
      {
        question: "How long has Nawins been operating?",
        answer: "Nawins Overseas Education has been helping students achieve their international education dreams for over 10 years. We have successfully placed 5,000+ students in top universities worldwide with a 95% visa success rate."
      }
    ]
  },
  {
      ...
      <section className="py-20 bg-gradient-to-r from-[#091f54] via-[#163886] to-[#1b47a8]">
        <div className="container">
          ...
          <p className="text-xl text-blue-100 max-w-2xl">
            Find answers to common questions about studying abroad with Nawins Overseas Education.
          </p>
        </div>
      </section>
