    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="py-20 bg-gradient-to-r from-purple-600 to-blue-600">
        <div className="container">
          <h1 className="text-5xl font-bold text-white mb-6">About Nawins</h1>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-lg text-gray-700 mb-4">
                Nawins Overseas Education started with a simple belief: that every student deserves access to world-class education and expert guidance. What began as a small team of two in a tiny office in Namakkal, Tamil Nadu, has grown into a dedicated organization with offices across Tamil Nadu.
              </p>
              <p className="text-lg text-gray-700 mb-4">
      ...
      <section className="py-20 bg-white">
        <div className="container">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-gray-900 mb-4">Why Choose Nawins</h2>
          </div>
