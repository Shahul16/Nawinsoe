          ...
          <div className="prose prose-lg prose-blue mx-auto">
            <Card className="p-8 mb-8 border-0 shadow-md">
              ...
              <p className="text-[#48608f] mb-4">
                By accessing and using the Nawins Overseas Education website and services, you accept and agree to be bound by these Terms of Service. If you do not agree to these terms, please do not use our services.
              </p>
            </Card>
            ...
            <Card className="p-8 mb-8 border-0 shadow-md">
              ...
              <p className="text-[#48608f] mb-4">
                Nawins Overseas Education provides educational consulting services including:
              </p>
            ...
            <Card className="p-8 mb-8 border-0 shadow-md">
              ...
              <p className="text-[#48608f]">
                All content on this website, including text, graphics, logos, and software, is the property of Nawins Overseas Education and is protected by copyright laws. You may not reproduce, distribute, or create derivative works without our written consent.
              </p>
            </Card>
