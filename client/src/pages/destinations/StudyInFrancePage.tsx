    ...
    <div className="min-h-screen bg-[#f7f9ff]">
      ...
      <section className="py-20 bg-gradient-to-r from-[#091f54] via-[#163886] to-[#1b47a8]">
        <div className="container">
          <h1 className="text-5xl font-bold text-white mb-6">Study in France</h1>
          <p className="text-xl text-blue-100 max-w-2xl">
            Experience world-class education in the land of art, culture, and innovation
          </p>
        </div>
      </section>
        ...
        <div className="container">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
            <Card className="p-6 text-center border border-blue-100/70">
              ...
              <p className="text-2xl font-bold text-[#07173d]">€2,770</p>
              <p className="text-sm text-[#48608f]">Annual Fees</p>
            </Card>
            <Card className="p-6 text-center border border-blue-100/70">
              <Calendar className="w-10 h-10 text-[#17337d] mx-auto mb-3" />
              <p className="text-2xl font-bold text-[#07173d]">Sep/Oct</p>
              <p className="text-sm text-[#48608f]">Main Intake</p>
            </Card>
            <Card className="p-6 text-center border border-blue-100/70">
              <MapPin className="w-10 h-10 text-[#17337d] mx-auto mb-3" />
              <p className="text-2xl font-bold text-[#07173d]">70+</p>
      ...
      <section className="py-20 bg-[#f7f9ff]">
        <div className="container">
          <div className="text-center mb-12">
            <h2 className="text-4xl font-bold text-[#07173d] mb-4">Why Study in France?</h2>
          </div>
      ...
      <section className="py-20 bg-white">
        <div className="container">
          <div className="text-center mb-12">
            <h2 className="text-4xl font-bold text-[#07173d] mb-4">Top French Universities</h2>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {topUniversities.map((uni, idx) => (
              <Card key={idx} className="p-6 border border-blue-100/70 bg-white hover:shadow-lg transition-all">
                ...
                <p className="text-sm text-[#48608f] mb-4">Premier French institution</p>
                <Button
                  size="sm"
      ...
      <section className="py-20 bg-white">
        <div className="container">
          <Card className="p-12 text-center bg-gradient-to-r from-[#091f54] via-[#163886] to-[#1b47a8]">
            <h2 className="text-4xl font-bold text-white mb-4">Ready to Study in France?</h2>
            <p className="text-xl text-blue-100 mb-8 max-w-2xl mx-auto">
              Get expert guidance for admission to top French universities
            </p>
            <Button
              size="lg"
