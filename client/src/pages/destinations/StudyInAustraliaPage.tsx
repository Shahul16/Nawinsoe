    ...
    <div className="min-h-screen bg-[#f7f9ff]">
      ...
      <section className="py-14 bg-[#f7f9ff]">
        <div className="container max-w-5xl">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            {QUICK_LINKS.map((l) => (
              <button
                ...
                className="text-left rounded-2xl border border-blue-100 bg-white p-5 hover:border-yellow-500/50 hover:bg-yellow-500/5 transition"
              >
          ...
          <div className="mt-8 rounded-2xl border border-yellow-500/25 bg-white p-6">
            <h3 className="text-xl font-bold text-[#07173d] mb-2">Next steps</h3>
            <p className="text-sm text-[#48608f] leading-relaxed">
              Use scholarships page for funding options, then follow visa guidance to prepare documents. If you want a tailored roadmap,
              book a free consultation.
            </p>
            <div className="mt-4 flex flex-wrap gap-3">
              <Button onClick={() => setLocation("/free-assessment")} className="bg-yellow-500 hover:bg-yellow-600 text-white rounded-full px-6">
                Free Assessment
              </Button>
              <Button
                variant="outline"
                onClick={() => setLocation("/book-consultation")}
                className="border-yellow-500/50 text-[#07173d] hover:bg-yellow-500/10 rounded-full px-6"
              >
                Book Consultation
              </Button>
            </div>
