...
export default function StudyInUK() {
  ...
  const nawinsPartnerUniversities = [
    ...
    { name: "Ulster University London", location: "London" },
    { name: "University of the West of Scotland", location: "London" },
    { name: "The University of Law", location: "London / Multiple" },
    { name: "University of Chester", location: "Chester" },
    { name: "University of Wolverhampton", location: "Wolverhampton" },
    { name: "University of Portsmouth", location: "Portsmouth" },
    { name: "Regent College London", location: "London" },
  ];
    ...
    <div className="min-h-screen bg-[#f7f9ff]">
      ...
      <section className="py-14 bg-[#f7f9ff]">
        <div className="container max-w-5xl">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            {QUICK_LINKS.map((l) => (
              <button
                ...
                className="text-left rounded-2xl border border-blue-100 bg-white p-5 hover:border-[#C59D50]/50 hover:bg-[#C59D50]/5 transition"
              >
          ...
          <div className="mt-8 rounded-2xl border border-[#C59D50]/25 bg-white p-6">
            <h3 className="text-xl font-bold text-[#07173d] mb-2">Next steps</h3>
            <p className="text-sm text-[#48608f] leading-relaxed">
              Use scholarships page to find funding options, then follow visa guidance to prepare documents. If you're ready,
              book a free consultation so we can verify your exact requirements.
            </p>
            <div className="mt-4 flex flex-wrap gap-3">
              <Button onClick={() => setLocation("/free-assessment")} className="bg-[#C59D50] hover:bg-[#B78D42] text-white rounded-full px-6">
                Free Assessment
              </Button>
              <Button
                variant="outline"
