  ...
  const successStories = [
    {
      id: 1,
      name: "Aarav Sharma",
      background: "B.Tech Engineering from Anna University",
      university: "University of Manchester",
      program: "MSc Software Engineering",
      location: "🇬🇧 UK",
      achievement: "Secured admission with £5,000 scholarship",
      visa: "✓ Student Visa Approved",
      quote: "Nawins made my UK admission dream possible. The entire process was smooth and stress-free.",
      currentStatus: "Final Year Student - Interning at Microsoft UK",
      avatar: "AS",
    ...
    },
    {
      id: 2,
      name: "Priya Mehta",
      background: "BBA Finance from Chennai Business School",
      university: "University of Toronto",
      program: "MBA",
      location: "🇨🇦 Canada",
      achievement: "Got admission to top-tier business school",
      visa: "✓ Study Permit Approved - Pathway to PR",
      quote: "The counselors at Nawins understood my career goals perfectly and guided me through every step.",
      currentStatus: "2nd Year MBA Student - Class Representative",
      avatar: "PM",
    ...
    },
    {
      id: 3,
      name: "Vikram Reddy",
      background: "B.Sc Computer Science from PSG College",
      university: "University of Melbourne",
      program: "Master of Data Science",
      location: "🇦🇺 Australia",
      achievement: "Admitted to Group of Eight university",
      visa: "✓ Student Visa Approved - Work Rights Included",
      quote: "Outstanding guidance on visa preparation and application strategy. Highly recommended!",
      currentStatus: "Employed at Major Tech Company - Post-Study Work Visa",
      avatar: "VR",
    ...
    },
    {
      id: 4,
      name: "Anjali Nair",
      background: "BCom Accounting from Loyola College",
      university: "Trinity College Dublin",
      program: "MSc International Business",
      location: "🇮🇪 Ireland",
      achievement: "Accepted to top European business school",
      visa: "✓ Student Visa Approved",
      quote: "Nawins' expertise in European education was invaluable. Great experience with the process!",
      currentStatus: "Working in Dublin - EU Tech Industry",
      avatar: "AN",
    ...
    },
    {
      id: 5,
      name: "Rohan Patel",
      background: "BE Electronics from VIT Chennai",
      university: "Imperial College London",
      program: "MSc Advanced Computing",
      location: "🇬🇧 UK",
      achievement: "Top-ranked engineering university admission",
      visa: "✓ Student Visa Approved - Post-Study Work Rights",
      quote: "The application support was exceptional. I couldn't have done it without Nawins.",
    ...
    <div className="min-h-screen bg-[#f7f9ff]">
      ...
      <section className="py-20 bg-white">
        <div className="container">
          <Reveal>
            <div className="text-center mb-12">
              <h2 className="text-4xl font-bold text-[#07173d] mb-4">The Nawins Journey</h2>
