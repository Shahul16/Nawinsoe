...
// Contact Us submission no longer depends on the database.
// Kept for backward compatibility with other parts of the codebase/tests.
export async function createInquiry(_data: InsertInquiry) {
  return null;
}
